...
import 'package:durakta_uyandir/domain/usecases/get_alarms.dart';
...
Future<void> init() async {
  ...
  sl.registerFactory(() => AlarmBloc(repository: sl(), settingsRepository: sl()));

  sl.registerLazySingleton(() => GetAlarms(sl()));

  sl.registerLazySingleton<AlarmRepository>(() => AlarmRepositoryImpl(localDataSource: sl()));
